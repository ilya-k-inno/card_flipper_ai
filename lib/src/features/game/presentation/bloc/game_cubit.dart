...
class GameCubit extends Cubit<GameState> {
  ...
  void initializeGame(List<String>? imageUrls, {bool isOfflineMode = false}) async {
  ...
  void cardTapped(int index) {
    ...
    final faceUpCards = currentState.cards.where((c) => c.isFaceUp && !c.isMatched).toList();
  ...
  void resetGame() {
    ...
    if (currentState is GameInProgress || currentState is GameWon) {
      final isOfflineMode = (currentState as GameInProgress).cards.any((card) => !card.isImageCard);
